            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        ...
                        <!-- The actual form -->
                        <form action="<?php echo URLROOT; ?>/users/register" method="POST" class="register-form" id="register-form">
                    ...
                    <div class="signup-image">
                        ...
                        <a href="<?php echo URLROOT; ?>/users/login" class="signup-image-link">I am already member</a>  <br><br>
                        <a href="<?php echo URLROOT; ?>/counsellors/counsellorRegister" class="signup-image-link">Sign Up as a Counsellor</a>
                    </div>
                </div>
            </div>
        </section>
