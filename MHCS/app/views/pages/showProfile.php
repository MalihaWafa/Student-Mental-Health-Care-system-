                    ...
                    <div class="row m-l-0 m-r-0">
                        <div class="col-sm-4 bg-c-lite-green user-profile">
                            <div class="card-block text-center text-white">
                                <div  class="nav-link center"> <img src="https://img.icons8.com/bubbles/100/000000/user.png" class="img-radius" alt="User-Profile-Image"> </div>
                                <h6 class="nav-link center">Username</h6>
                                <p class="nav-link center">
                        ...
                        <div class="col-sm-8">
                            <div class="card-block">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <p class="m-b-10 f-w-600">Institution of Study</p>
                                        <h6 class="text-muted f-w-400">University of Technology Malaysia</h6>
                                        
                                    </div>
                                    <div class="col-sm-6">
                                        <p class="m-b-10 f-w-600">Study Status</p>
                                        <h6 class="text-muted f-w-400">Full-Time</h6>
                                    </div>
                                </div>
