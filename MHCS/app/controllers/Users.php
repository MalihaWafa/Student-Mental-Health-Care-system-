...
class Users extends Controller{                         //This Controller class is for redirecting and authenticating login only as opposed to pages.
    ...
    public function register()
    {
        ...
        $this->view('users/register', $data);           //This is the redirect to the register page
    }
    ...
    public function login()
    {
        ...
        $this->view('users/login', $data);              //This is the redirect to the login page
    }
